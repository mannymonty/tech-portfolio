...
- **Smart email distribution**: Auto-attaches results via Outlook COM, detects oversized files (>20MB), sends follow-up with shared drive links instead, archives to WorkDocs.
...
- `Outputs/Latest/` directory tree with 20+ reporting suites auto-maintained
- `logs/` directory showing 117 production run logs (Nov 2025 – present)
- WoW % change heatmap (red/yellow/green customer cohort movement)
- Before/after: 6-hour Monday morning process vs. 25-minute automated pipeline
